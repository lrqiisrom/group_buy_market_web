                ...
                >
                    {[0, 1, 2].map((index) => (
                        <div key={index} className="carousel-item">
                            <Image
                                src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-HavmFODxRooapIVUzvwde5QBI8EUDn.png"
                                alt="MyBatis书籍"
                                width={600}
                                height={250}
        ...
        <div className="tag">正品保障</div>
            ...
            <div className="group-buy">
                ...
                <div className="group-users">
                    {[
                        { name: "小傅哥", purchases: 22, remaining: 1 },
                        { name: "李二狗", purchases: 11, remaining: 2 },
                    ].map((user, index) => (
                        <div key={index} className="user-item">
                            <div className="user-info">
                                ...
                                <div>
                                    ...
                                    <div className="purchase-count">数码买过{user.purchases}次</div>
                                </div>
                            </div>
                            <div className="group-status">
                                <div className="no-wait">无需等待</div>
                                <div className="status-text">组队仅剩{user.remaining}人，拼单即将结束</div>
